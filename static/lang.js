const translations = {
  ...
  en: {
    ...
    model_desc_text: "The system is designed for the optimal selection of information security solutions (ISS) subject to financial constraints for various asset groups (AG). The model minimizes risks, balancing total bypass time and minimum security department response time of the weakest link via the λ coefficient.",
    ...
    param_b_desc: "Financial constraints for each asset group",
    ...
    example_guide_vectors: "<b>Parameter Vectors:</b> Next are three vectors: b (financial constraints for 3 AGs), c (bypass time for 4 ISS), and d (minimum response time for 4 ISS).",
